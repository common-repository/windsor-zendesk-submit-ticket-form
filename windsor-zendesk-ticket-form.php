				...
				<div class="meta-box-sortables ui-sortable">
					...
					<div id="mm-panel-secondary" class="postbox">
						...
						<div class="toggle<?php if (!isset($_GET["settings-updated"])) { echo ' default-hidden'; } ?>">
							...
							<p><code class="mm-code">[windsor_zendesk_ticket_form]</code></p>
							<h3><?php _e('Template tag', 'zdf'); ?></h3>
							<p><?php _e('Use this template tag to display the form anywhere in your theme template:', 'zdf'); ?></p>
							<p><code class="mm-code">&lt;?php if (function_exists('windsor_zendesk_ticket_form')) windsor_zendesk_ticket_form(); ?&gt;</code></p>
						</div>
					</div>
